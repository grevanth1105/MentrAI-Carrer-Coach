    ...
    <div className='space-y-6'>
       <div className='flex justify-between items-center'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
         <Card>
          <CardHeader className='flex flex-row items-center justify-between spaxe-y-0 pb-2'>
            <CardTitle className='text-2xl font-medium'>Market Outlook</CardTitle>
          ...
          <Card>
          <CardHeader className='flex flex-row items-center justify-between spaxe-y-0 pb-2'>
            <CardTitle className='text-2xl font-medium'>Industry Growth</CardTitle>
